...
#ifndef GAZEBO_PLUGINS__HT_NAV_GAZEBO_ROS_CONTACT_SENSOR_HPP_
#define GAZEBO_PLUGINS__HT_NAV_GAZEBO_ROS_CONTACT_SENSOR_HPP_
...
/**
  ...
  \endcode
*/
class HTNavGazeboRosContactSensor : public gazebo::SensorPlugin
{
public:
  /// Constructor
  HTNavGazeboRosContactSensor();

  /// Destructor
  virtual ~HTNavGazeboRosContactSensor();
...
private:
  ...
  std::unique_ptr<HTNavGazeboRosContactSensorPrivate> impl_;
};

}  // namespace gazebo_plugins

#endif  // GAZEBO_PLUGINS__HT_NAV_GAZEBO_ROS_CONTACT_SENSOR_HPP_
